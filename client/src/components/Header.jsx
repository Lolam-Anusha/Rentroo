...
const Header = () => {
  ...
  const BookingIcon = () => (
    ...
    >
      ...
      <path d="M8 21h12a2 2 0 0 0 2-2v-1a1 1 0 0 0-1-1H11a1 1 0 0 0-1 1v1a1 1 0 0 1-1 1H4a2 2 0 0 0-2 2v1" />
    </svg>
  );
        ...
        <div className='flexBetween'>
          ...
          <div className='flex sm:flex-1 items-center sm:justify-end gap-x-4 sm:gap-x-8'>
            ...
            <div className='relative hidden xl:flex items-center'>
              {/* Input */}
              <div className={`transition-all duration-300 ease-in-out ring-1 ring-slate-900/10 bg-white 
